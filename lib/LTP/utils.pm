...
sub log_versions {
    ...
    assert_script_run("echo $dir; ls -la $dir || true; pwd; cd $dir " . ' && pwd && make -j$(getconf _NPROCESSORS_ONLN)', timeout => 600);
    $dir = 'testcases/kernel/syscalls/keyctl/';
